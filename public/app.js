...
function render() {
  ...
  $('citations').replaceChildren(...node.citations.map((citation) => { const link = document.createElement('a'); link.href = citation.url; link.target = '_blank'; link.rel = 'noreferrer'; link.textContent = `Source: ${citation.label}`; return link; }));
